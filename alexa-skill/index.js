...
function onIntent(intentRequest, session, callback) {
    ...
    if (  intentName == "sportIntent" || intentName == "apiIntent" || intentName == "productsIntent") {
...
function getWelcomeResponse(callback) {
    ...
    wasLogged = false;
        ...
        var speechOutput = "Hi and welcome to the Find it assistant. I can help you to hire best developers right from your bed. How can I help you?"
